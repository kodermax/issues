...
class ViewComponent extends Component {
  ...
  render() {
    ...
    return (
        <Layout subcategory="auto">
            {this.state.item ? <div>
                <h2 className={classes.h2}>№ {this.state.item.id} {this.state.item.title}</h2>
                <Actions issueId={this.props.routeParams.id} subcategory="auto" />
                <div className={classes.form}>
                    <div className="dx-fieldset">
                        ...
                        <div className="dx-field">
                            <div className="dx-field-label">Водитель:</div>
                            <div className="dx-field-value-static">{this.state.item.driver}</div>
                        </div>
                        <div className="dx-field">
