  ...
  handleSubmit(e: Object) {
    ...
    if (result.isValid) {
      ...
      let request = {
        ...
        'invoice': form.getEditor('invoice').option('value'),
    ...
    const items = [
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: { text: 'Наименование поставщика' },
            helpText: 'Полное наименование организации-поставщика',
            editorType: 'dxSelectBox',
            editorOptions: {
          ...
          },
          {
            ...
            label: { text: 'Контактное лицо поставщика' },
            validationRules: [{
              type: 'required',
              message: 'Обязательное поле'
            }]
          },
          {
            ...
            label: { text: 'Телефон контактного лица поставщика' },
            validationRules: [{
              type: 'required',
              message: 'Обязательное поле'
            }]
