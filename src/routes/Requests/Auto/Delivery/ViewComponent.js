    ...
    return (
        <Layout subcategory='delivery'>
            {this.state.item ? <div>
                ...
                <Actions issueId={this.props.routeParams.id} subcategory='delivery' />
                <div className={classes.form}>
                    <div className="dx-fieldset">
                        ...
                        <div className="dx-field">
                            <div className="dx-field-label">Телефон автора:</div>
                        ...
                        <div className="dx-field">
                            <div className="dx-field-label">Номер и дата счёта:</div>
                            <div className="dx-field-value-static">{this.state.item.invoice}</div>
                        </div>
                        <div className="dx-field">
